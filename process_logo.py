...
def extract_logo(input_path, output_path, target_color=(65, 40, 20)):
    # Read the image
    ...
    # The text is very dark (close to 0-50 in original), so alpha should be high for those regions
...
if __name__ == "__main__":
    # #142841 is Navy Blue -> R:20, G:40, B:65
    extract_logo("static/logo.png", "static/logo_extracted.png", target_color=(65, 40, 20))
